"""
  Batch processing from one aris drive to mp4 drive
  TODO: multithread and CUDA acceleration
"""
...
def process_directory(aris_drive_path, mp4_drive_path):
    ...
    for aris_file_path in aris_files:
        ...
        if os.path.exists(mp4_file_path):  # Check if the MP4 file already exists
            logging.info(f"Skipping conversion, already exists: {mp4_file_path}")
